...
import { AiFillCaretRight, AiFillEnvironment } from "react-icons/ai";
        ...
        <div className="lg:flex lg:justify-around ">
          <div className="px-5 grid grid-cols-1  gap-5 md:grid-cols-2 lg:grid-cols-4 text-left">
            ...
            <div >
              ...
              <ul className="text-white dark:text-gray-400 font-medium flex flex-col sm:flex  md:items-start ">
            ...
            <div>
              ...
              <ul className="text-white dark:text-gray-400 font-medium">
                <li className="mb-2 flex flex-row items-start justify-start">
                  ...
                  <p className="pl-2 text-sm">
                    123 Street, Rawalpindi, Pakistan
                  </p>
                </li>
                <li className="mb-2 flex flex-row items-start justify-start">
                  <IoMdCall />
                  <p className="pl-2 text-sm">+012 345 6789</p>
                </li>
                <li className="mb-2 flex flex-row items-start justify-start">
                  <TiMessages />
              ...
              <div className="flex pt-4 space-x-5 justify-start  sm:mt-0">
                <a
                  href="#"
                  className="text-white hover:text-gray-900 dark:hover:text-white border border-white  dark:border-white hover:bg-secondary rounded-full p-1"
                >
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
